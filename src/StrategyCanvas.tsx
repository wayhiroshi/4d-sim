...
export default function StrategyCanvas(p: Props) {
  ...
  return <div className="strategy-canvas">
    ...
    <footer className="canvas-footnote"><span>非公式・条件付き試算。一時ボーナスは継続月額に含めません。</span><NavLink to="/reference/titles">タイトル条件表</NavLink></footer>
  </div>;
}
