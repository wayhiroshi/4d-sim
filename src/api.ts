...
export const api = {
  ...
  updateMemberIdentity: (id: string, displayName: string, idKind: Member["idKind"]) => request<{ id: string; displayName: string; idKind: Member["idKind"] }>(`/api/v1/members/${encodeURIComponent(id)}/identity`, { method: "PATCH", body: JSON.stringify({ displayName, idKind }) }),
